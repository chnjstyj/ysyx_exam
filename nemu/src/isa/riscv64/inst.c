...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 0111011",sllw,R,R(dest) = SEXT(BITS((uint32_t)src1 << BITS(src2,4,0),31,0),31));
  INSTPAT("0000000 ????? ????? 101 ????? 0111011",srlw,R,R(dest) = SEXT(BITS((uint32_t)src1 >> BITS(src2,4,0),31,0),31));
  INSTPAT("0100000 ????? ????? 101 ????? 0111011",sraw,R,R(dest) = SEXT(BITS((int32_t)src1 >> BITS(src2,4,0),31,0),31));
