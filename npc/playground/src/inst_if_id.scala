...
class inst_if_id extends RawModule{
    ...
    withClockAndReset(io.clk,io.rst){
        ...
        io.id_inst_address := RegEnable(io.inst_if_inst_address,"h00000000".U,enable)
        io.id_next_inst_address := RegEnable(io.inst_if_next_inst_address,"h00000000".U,enable)
